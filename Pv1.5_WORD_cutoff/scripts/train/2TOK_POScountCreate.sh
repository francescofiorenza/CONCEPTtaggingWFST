...
cat $dataFolder/original/$trainFeatFileName|cut -f 2 >$dataFolder/original/tempConceptTrain
cat $dataFolder/original/$testFeatFileName|cut -f 2 >$dataFolder/original/tempConceptTest
